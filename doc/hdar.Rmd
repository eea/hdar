...
You can edit the generated query template to specify the values for the fields as needed. If you decide not to edit the placeholder values and use the generated query template directly in the search function, the fields with placeholder values (the ones starting with __###) will be stripped off before sending the query to the HDA service.
